...
const Carts = () => {
  ...
  const isSpecialProduct = (productName) => specialProducts.includes(productName);
              ...
              >
                ...
                <View className="flex-1 pl-2">
                  ...
                  <View className="flex-row items-center">
                    ...
                    <Text className="mx-2">
                      {item.qtyOrdered} {isSpecialProduct(item.product_Name) ? 'sacks' : 'kg'}
                    </Text>
                    <TouchableOpacity onPress={() => handleQuantityChange(item.id, 0.25)}>
                      <View className="rounded-full p-2 bg-gray-200">
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>+</Text>
